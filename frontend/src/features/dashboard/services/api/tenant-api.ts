...
import type {
  HierarchyType,
  TenantChildLocationsResponse,
  TenantListContainer,
  TenantListItem,
  TenantListResponse,
  TenantLocationHierarchyResponse,
  TenantPublicConfig,
} from './dashboard-api'
import {
  type ApiEnvelope,
  ...
  readDepartmentMapLevelsWithCascade,
  readLgdMapLevelsWithCascade,
  resolveTenantListContainer,
...
export const tenantApi = {
  getTenantPublicConfig: async (tenantId: number): Promise<TenantPublicConfig> => {
    ...
    return {
      ...
      displayDepartmentMaps: readBooleanConfigValue(configs?.DISPLAY_DEPARTMENT_MAP?.value, true),
