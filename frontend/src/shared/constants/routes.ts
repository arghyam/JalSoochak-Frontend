export const ROUTES = {
  ...
  SUPER_ADMIN_SYSTEM_RULES: '/super-user/system-rules',
  ...
  SUPER_ADMIN_API_CREDENTIALS: '/super-user/api-credentials',
  SUPER_ADMIN_INGESTION_MONITOR: '/super-user/ingestion-monitor',
